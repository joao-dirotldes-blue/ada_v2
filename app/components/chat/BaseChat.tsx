...
import { CustomModelSelector } from '~/components/chat/CustomModelSelector';
...
export const BaseChat = React.forwardRef<HTMLDivElement, BaseChatProps>(
  (
    ...
    // Always keep model settings collapsed/hidden
                ...
                >
                  <svg className={classNames(styles.PromptEffectContainer)}>
                    <defs>
                      ...
                      >
                        <stop offset="0%" stopColor="#4169E1" stopOpacity="0%"></stop>
                        <stop offset="40%" stopColor="#4169E1" stopOpacity="80%"></stop>
                        <stop offset="50%" stopColor="#4169E1" stopOpacity="80%"></stop>
                        <stop offset="100%" stopColor="#4169E1" stopOpacity="0%"></stop>
                      </linearGradient>
                  ...
                  >
                    ...
                    <div className="flex justify-between items-center text-sm p-4 pt-2">
                      <div className="flex gap-1 items-center">
                        ...
                        {/* Model settings button removed as requested */}
                      </div>
                      {input.length > 3 ? (
